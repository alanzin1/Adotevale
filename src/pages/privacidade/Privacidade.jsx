...
export default function Privacidade() {
  return (
    <main className={styles.container}>
      ...
      <p>
        O usuário declara possuir autorização para fornecer os dados informados
        e assume total responsabilidade pela veracidade das informações.
      </p>
      ...
      <ul>
        <li>Publicar anúncios de animais disponíveis para adoção</li>
        <li>
      ...
      <p>
        O tratamento dos dados pessoais é realizado com base no consentimento do
        titular, manifestado de forma livre e inequívoca no momento do cadastro
        do animal e do aceite dos Termos de Uso e desta Política de Privacidade.
      </p>

      <h2>4. Compartilhamento e divulgação de dados</h2>
      <p>
        O Adotevale não vende, aluga ou comercializa dados pessoais. O número de
        WhatsApp informado será exibido publicamente na plataforma com a única
        finalidade de permitir o contato para adoção.
      </p>

      <p>
        O Adotevale não se responsabiliza pelo uso dos dados realizado por
        terceiros após o contato externo à plataforma, incluindo interações via
        WhatsApp, redes sociais ou outros meios.
      </p>

      <h2>5. Armazenamento e segurança dos dados</h2>
      <p>
        Os dados são armazenados em ambiente controlado e seguro, com acesso
        restrito a pessoas autorizadas para fins de manutenção e moderação da
        plataforma. Apesar das medidas adotadas, não é possível garantir
      ...
      <p>
        ...
        enquanto forem necessários para o cumprimento das finalidades descritas
        nesta política.
      </p>

      <p>
        A exclusão dos dados poderá ser solicitada pelo responsável pelo anúncio
        por meio dos canais oficiais do Adotevale, ou poderá ocorrer
      ...
      <p>
        Nos termos da LGPD, o titular dos dados poderá solicitar, a qualquer
        momento:
      </p>
      ...
      <p>
        O usuário compromete-se a não fornecer dados de terceiros sem
        autorização, bem como a manter seus dados corretos e atualizados.
      </p>

      <p>
        O Adotevale não se responsabiliza por danos decorrentes do uso indevido
        das informações por terceiros após a divulgação pública do anúncio.
      </p>
